...
import {REACT_APP_PAYPAL_CLIENT_ID} from '../../constants';
...
export default function ({navigation, route}) {
  ...
  const payPal = () => {
    PayPal.initialize(PayPal.NO_NETWORK, REACT_APP_PAYPAL_CLIENT_ID);
    PayPal.pay({
      price: `${price}`,
      currency: 'USD',
    ...
    <View style={styles.PrivacyPolicy}>
      <Modal
        ...
        <View style={styles.centeredView}>
          <Text style={styles.notification}>Payment Successful</Text>
      ...
      <View
        ...
        {/* <View
          ...
          onTouchEnd={() => payPal()}>
          <Text style={{textAlign: 'center', color: 'white', fontSize: 14, alignContent: 'center'}}>
            STRIPE
          </Text>
        </View> */}
        <View
          ...
          onTouchEnd={() => onClickPaymentMethod(1)}>
          <Image
            source={require('./i_mastercard.png')}
            style={{alignSelf: 'center', marginTop: 10}}
          />
        </View>
        <View
          ...
          onTouchEnd={() => onClickPaymentMethod(2)}>
          <Image
            source={require('./i_visa.png')}
            style={{alignSelf: 'center', marginTop: 10}}
          />
        </View>
      </View>
