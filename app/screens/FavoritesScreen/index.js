      ...
      <ScrollView
        ...
        <View
          ...
          <View
            ...
            onTouchEnd={() => navigation.navigate('ProductDetail')}>
            <Image
              source={require('./store1.png')}
          ...
          <View
            ...
            <Image
              source={require('./i_heart_red.png')}
              style={{position: 'absolute', right: 5, bottom: 20}}
            />
          </View>
        </View>
