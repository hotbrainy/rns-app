...
export default function ({navigation, route, products, addToCart}) {
  ...
  const onClickPay = () => {
    ...
    navigation.navigate('ProductPaymentMethod', {
      amount: total,
      id: userId,
    });
  };
  ...
  return (
    <SafeAreaView style={styles.PrivacyPolicy}>
      ...
      <View
        ...
        <Image
          source={{uri: imageUrl + 'products/image/' + product?.album}}
        ...
        <View
          ...
          <View
            ...
            <Text style={{color: '#1455F5', fontSize: 12, marginLeft: 20}}>
              ${product?.price}
            </Text>
          </View>
        </View>
      ...
      <View
        ...
        <Text style={{fontSize: 14, fontWeight: '600', color: 'white'}}>
          {amount} items(s), Total:{' '}
          <Text style={{color: '#1455F5'}}>${getTotal(product)}</Text>
        </Text>
      </View>
      ...
      <View
        ...
        <Text style={{fontSize: 14, fontWeight: '600', color: 'white'}}>
          Total :{' '}
          <Text style={{color: '#1455F5'}}>${getSubTotal(product)}</Text>
        </Text>
      </View>
      <View
        style={{
